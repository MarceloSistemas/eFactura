<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCRUDMAESTRO_DocTipo.aspx.vb" Inherits="eFactura.Web.frmCRUDMAESTRO_DocTipo" %>
...
<td><cc1:TextBoxTyped id="txtCODIGO_ERP" runat="server"  Width="400px" CssClass="TextBox" ToolTip="CODIGO_ERP"  MaxLength="50" TextBoxWidth="AutoSize"  TextBoxType="strings" ></cc1:TextBoxTyped></td>
                    ...
                    <cc1:CRUDManagerHeader ID="objCRUDManagerHeader" runat="server" AutoQueryList="False"
                        BzAssemblyName="eFactura.BusObjects" BzClassName="eFactura.BusObjects.MAESTRO_DocTipo" CRUDToolBarName="objCRUDToolBarHeader"
                        DataGridQueryListName="dgrList" DataMemberName="MAESTRO_DocTipo" MenuName="objMenu" SearchPanelName="PanelSearch"
