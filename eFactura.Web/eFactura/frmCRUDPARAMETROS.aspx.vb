...
Public Partial Class frmCRUDPARAMETROS
...
objWebDataBinder.Add(Me.txtVALOR.ID,false)
End Sub
...
If (Me.txtPARAMETRO_ID_SEARCH.Text <> "") Then
   objQueryParameters.Add(New SqlParameter("@PARAMETRO_ID",Me.txtPARAMETRO_ID_SEARCH.Text))
End If
...
Me.txtPARAMETRO_ID_SEARCH.Text = "" 
Me.objWebDataBinder.ClearContents()
