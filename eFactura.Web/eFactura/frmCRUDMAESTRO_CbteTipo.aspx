<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCRUDMAESTRO_CbteTipo.aspx.vb" Inherits="eFactura.Web.frmCRUDMAESTRO_CbteTipo" %>
...
<td><cc1:TextBoxTyped id="txtCodigo_SEARCH" runat="server"  Width="64px" CssClass="TextBox" ToolTip="Codigo"  MaxLength="8" TextBoxWidth="UserSize"  TextBoxType="integers" ></cc1:TextBoxTyped></td>
</tr>
<tr>
...
<td><cc1:TextBoxTyped id="txtCODIGO_ERP" runat="server"  Width="400px" CssClass="TextBox" ToolTip="CODIGO_ERP"  MaxLength="50" TextBoxWidth="AutoSize"  TextBoxType="strings" ></cc1:TextBoxTyped></td>
                    ...
                    <cc1:CRUDManagerHeader ID="objCRUDManagerHeader" runat="server" AutoQueryList="False"
                        BzAssemblyName="eFactura.BusObjects" BzClassName="eFactura.BusObjects.MAESTRO_CbteTipo" CRUDToolBarName="objCRUDToolBarHeader"
                        DataGridQueryListName="dgrList" DataMemberName="MAESTRO_CbteTipo" MenuName="objMenu" SearchPanelName="PanelSearch"
