<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCRUDMAESTRO_TipoIva.aspx.vb" Inherits="eFactura.Web.frmCRUDMAESTRO_TipoIva" %>
...
<td><cc1:TextBoxTyped id="txtCODIGO_ERP" runat="server"  Width="400px" CssClass="TextBox" ToolTip="CODIGO_ERP"  MaxLength="50" TextBoxWidth="AutoSize"  TextBoxType="strings" ></cc1:TextBoxTyped></td>
                    ...
                    <cc1:CRUDManagerHeader ID="objCRUDManagerHeader" runat="server" AutoQueryList="False"
                        BzAssemblyName="eFactura.BusObjects" BzClassName="eFactura.BusObjects.MAESTRO_TipoIva" CRUDToolBarName="objCRUDToolBarHeader"
                        DataGridQueryListName="dgrList" DataMemberName="MAESTRO_TipoIva" MenuName="objMenu" SearchPanelName="PanelSearch"
