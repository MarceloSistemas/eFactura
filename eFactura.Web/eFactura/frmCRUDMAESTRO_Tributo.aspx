<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCRUDMAESTRO_Tributo.aspx.vb" Inherits="eFactura.Web.frmCRUDMAESTRO_Tributo" %>
...
<td><cc1:TextBoxTyped id="txtCodigo_SEARCH" runat="server"  Width="40px" CssClass="TextBox" ToolTip="Codigo"  MaxLength="5" TextBoxWidth="UserSize"  TextBoxType="integers" ></cc1:TextBoxTyped></td>
</tr>
<tr>
...
<td><cc1:TextBoxTyped id="txtCODIGO_ERP" runat="server"  Width="400px" CssClass="TextBox" ToolTip="CODIGO_ERP"  MaxLength="50" TextBoxWidth="AutoSize"  TextBoxType="strings" ></cc1:TextBoxTyped></td>
                    ...
                    <cc1:CRUDManagerHeader ID="objCRUDManagerHeader" runat="server" AutoQueryList="False"
                        BzAssemblyName="eFactura.BusObjects" BzClassName="eFactura.BusObjects.MAESTRO_Tributo" CRUDToolBarName="objCRUDToolBarHeader"
                        DataGridQueryListName="dgrList" DataMemberName="MAESTRO_Tributo" MenuName="objMenu" SearchPanelName="PanelSearch"
